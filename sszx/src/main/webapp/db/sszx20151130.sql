...
insert  into `dxx`(`id`,`zt`,`nr`,`fszd`,`mc`,`fydm`,`zdfs`) values (1,'0','[承办人]法官您好，您的案件[案号]的当事人[当事人]，有材料提交到诉讼中心，请和诉讼中心[转交人]联系领取。',0,'通知法官接收当事人主动递交材料','330103',0),(2,'9','[当事人]你好，你需要将[案号]的相关材料在[时限]日内递交到[法院名称]诉讼服务中心。',0,'通知当事人递交材料','330103',0),(3,'10','[承办人]法官您好，您预约的案件[案号]当事人[当事人]已经将材料交至诉讼中心，请联系诉讼中心[转交人]领取。',0,'法官领取预约提交材料','330103',0),(4,'6','[当事人]你好，你的案件[案号]有材料需要在[时限]日内到[法院名称]诉讼中心领取。',0,'通知当事人领取材料','330103',0),(5,'7','[承办人]法官您好，您的案件[案号]的材料已被当事人[当事人]领取。',0,'通知法官材料已被当事人接收','330103',0);
...
CREATE TABLE `sms` (
  ...
  `smsid2` varchar(500) DEFAULT NULL,
  `smszt` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `zd` (
  ...
  `editable` int(5) DEFAULT '1',
  PRIMARY KEY (`zdbm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `zd` */

insert  into `zd`(`zdbm`,`zdmc`,`editable`) values ('cyclqd','常用材料清单',0),('js','角色',0),('thyy','退回原因',0),('ywlx','业务类型',0),('zt','状态',1);
...
CREATE TABLE `zjqd` (
  `bh` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '编号',
  ...
  `sxsj` timestamp NULL DEFAULT NULL COMMENT '时限时间',
  `ywlx` int(10) DEFAULT NULL,
  `zjrxm` varchar(200) DEFAULT NULL COMMENT '转接人姓名',
  `clqd` varchar(2000) DEFAULT NULL COMMENT '材料清单描述',
  `dlr` varchar(100) DEFAULT NULL,
  `dlrdh` varchar(20) DEFAULT NULL,
  `zyzh` varchar(100) DEFAULT NULL,
  `sfck` int(2) DEFAULT '0' COMMENT '被领取案件，是否被查看 0否 1是',
  PRIMARY KEY (`bh`,`fydm`),
  KEY `ah` (`ah`),
  KEY `sjr` (`sjr`),
  KEY `djr` (`djr`)
