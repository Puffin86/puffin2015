...
CREATE TABLE `sms` (
  ...
  `bh` int(11) DEFAULT NULL COMMENT '编号',
  `smsid2` varchar(500) DEFAULT NULL COMMENT '短信编号2',
  `smszt` varchar(5) DEFAULT NULL COMMENT '短信状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `zjqd` (
  ...
  `ahdm` varchar(100) NOT NULL COMMENT '案号代码',
  ...
  `ywlx` int(10) DEFAULT NULL COMMENT '业务类型',
